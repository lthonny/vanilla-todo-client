...
export class View {
    ...
    constructor(
        ...
        const characters: HTMLElement = document.querySelector('.max-characters'); // more specific type
    ...
    createTaskSwitch(currentTask: any): HTMLElement { // no any!
    ...
    createEditText(inputDiv: HTMLElement, currentTask: any, taskElements): void { // no any! types!
    ...
    modalWindow() {
        ...
        return new Promise(function (res, rej) { // arrow functions
     ...
     async render() {
        ...
        try {
            ...
            const filteredTasks = tasks.sort((a, b) => a.order - b.order).filter(task => {
